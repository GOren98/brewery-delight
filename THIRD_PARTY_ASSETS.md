# Third-party asset provenance (MVP 6.1)
...
Pam's HarvestCraft 2 Crops was inspected as a compatibility/reference source, but its `All Rights Reserved` resources are **not committed** to this public repository. Temporary missing-crop sprites (rye, agave, juniper, millet, anise) are instead derived from Croptopia's MIT-licensed crop art for MVP testing.
